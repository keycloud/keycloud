...
func main() {
	...
	*/
	...
	//sign in routes
	webauthnRouter.HandleFunc("/dashboard/index.html", fileServer.ServeFileWithoutCheck).Methods(http.MethodGet)
	webauthnRouter.HandleFunc("/dashboard/signin.css", fileServer.ServeFileWithoutCheck).Methods(http.MethodGet)
